...
public enum ExtendedInterval: Int, CaseIterable {
    /// Perfect Unison
    case P1
    ...
    ///   - note2: Second Note
    /// - Returns: Interval
    static func betweenNotes(_ note1: Note, _ note2: Note) -> ExtendedInterval? {
        var n1 = note1
        var n2 = note2
        ...
        degree += 1
        for interval in ExtendedInterval.allCases {
...
extension ExtendedInterval: CustomStringConvertible {
