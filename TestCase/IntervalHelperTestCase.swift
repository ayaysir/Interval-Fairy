...
struct IntervalHelperTestCase {
    ...
    private func test_countOfHalfStep(scale7: MusicNote.Scale7, intervalNumber: Int) {
        guard let countOfHalfStep = IntervalHelper.shared.countOfHalfStep(scale7: scale7, intervalNumber: intervalNumber) else {
            return
        }
        
        print(#function, scale7, intervalNumber, countOfHalfStep)
    }
    ...
    init() {
        ...
        // 4, 8, 11, 15, 18, 22...
        // 1, 2,  3,  4,  5,  6...
        test_countOfHalfStep(scale7: .C, intervalNumber: 3)
        test_countOfHalfStep(scale7: .C, intervalNumber: 4)
        test_countOfHalfStep(scale7: .C, intervalNumber: 7)
        test_countOfHalfStep(scale7: .C, intervalNumber: 8)
        test_countOfHalfStep(scale7: .C, intervalNumber: 11)
        test_countOfHalfStep(scale7: .C, intervalNumber: 15)
        test_countOfHalfStep(scale7: .C, intervalNumber: 18)
        test_countOfHalfStep(scale7: .C, intervalNumber: 22)
